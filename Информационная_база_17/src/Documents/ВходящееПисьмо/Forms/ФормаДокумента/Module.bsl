...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	Если ЗначениеЗаполнено(ДанныеОтправителя.Контакт) Тогда
		 ...
		 Элементы.СоздатьЗаказчика.Доступность = Ложь;
...
Процедура СоздатьЗаказчика(Команда)
	...
	Если Не ЗначениеЗаполнено(ОтправительКонтакт) Тогда
		...
		РежимОткрытияОкна = РежимОткрытияОкнаФормы.БлокироватьОкноВладельца;
		ОткрытьФорму("Справочник.Заказчики.ФормаОбъекта", ПараметрыФормы, , , , , , РежимОткрытияОкна);
...
Процедура СоздатьКонтактноеЛицо(Команда)
	...
	Если Не ЗначениеЗаполнено(ОтправительКонтакт) Тогда
		...
		РежимОткрытияОкна = РежимОткрытияОкнаФормы.БлокироватьОкноВладельца;
		ОткрытьФорму("Справочник.Заказчики.ФормаВыбора", , , , , , ОписаниеОповещения, РежимОткрытияОкна);
...
Процедура СоздатьКонтактноеЛицоЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ПараметрыФормы = Новый Структура("Адрес, Представление, Владелец", 
		Адрес,
		Представление,
		Результат);
	...
	РежимОткрытияОкна = РежимОткрытияОкнаФормы.БлокироватьОкноВладельца;
	ОткрытьФорму("Справочник.КонтактныеЛицаЗаказчиков.ФормаОбъекта", ПараметрыФормы, , , , , , РежимОткрытияОкна);
