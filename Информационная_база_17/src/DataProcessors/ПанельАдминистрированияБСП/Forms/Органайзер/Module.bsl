...
&НаКлиенте
Процедура ИспользоватьЦентрОповещенияДляНапоминанийПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
КонецПроцедуры
...
&НаКлиенте
Процедура ОткрытьНастройкиВстроеннойПочты(Команда)
	ОткрытьФорму("Обработка.ПанельАдминистрированияБСП.Форма.Почта");
КонецПроцедуры
