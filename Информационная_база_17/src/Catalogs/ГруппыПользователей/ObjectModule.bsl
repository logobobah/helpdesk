...
Процедура ПередЗаписью(Отказ)
	...
	Иначе
		РеквизитыГруппыПоСсылке = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Ссылка, "Наименование, ПометкаУдаления");
...
Процедура ПриЗаписи(Отказ)
	...
	Если ОбновитьДанныеИсполнителяВАдреснойКниге Тогда
		Справочники.АдреснаяКнига.ОбновитьДанныеОбъекта(
			Ссылка, Родитель, Справочники.АдреснаяКнига.Исполнители, Ссылка);
	КонецЕсли;
