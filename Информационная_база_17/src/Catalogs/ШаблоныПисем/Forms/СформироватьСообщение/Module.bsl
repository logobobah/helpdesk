...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РежимВыбора        = Не Параметры.РежимФормированияПисьма И Не Параметры.ПодготовитьШаблон;
	...
	Если ТипЗнч(Предмет) <> Тип("Строка") И Предмет <> Неопределено Тогда
	...
	Если НЕ ПравоДоступа("Изменение", Метаданные.Справочники.ШаблоныПисем) Тогда
...
Процедура ШаблоныПриАктивизацииСтроки(Элемент)
	Если Элемент.ТекущиеДанные <> Неопределено Тогда
		...
		Если Элемент.ТекущиеДанные.ТипТекста = ПредопределенноеЗначение("Перечисление.ТипыТекстовПочтовыхСообщений.HTML") Тогда
...
Процедура ШаблоныПередНачаломИзменения(Элемент, Отказ)
	...
	Если Элемент.ТекущиеДанные <> Неопределено Тогда
		...
		ОткрытьФорму("Справочник.ШаблоныПисем.ФормаОбъекта", ПараметрыФормы);
	КонецЕсли;
КонецПроцедуры
...
Процедура ВводПараметров(Шаблон, ПараметрыОтправки, ОтправлятьСразу)
	...
	ОткрытьФорму("Справочник.ШаблоныПисем.Форма.ЗаполнитьПроизвольныеПараметры", ПараметрыДляЗаполнения,,,,, Оповещение);
...
Процедура СоздатьНовыйШаблон(ЗначениеКопирования = Неопределено)
	...
	ОткрытьФорму("Справочник.ШаблоныПисем.ФормаОбъекта", ПараметрыФормы, ЭтотОбъект);
