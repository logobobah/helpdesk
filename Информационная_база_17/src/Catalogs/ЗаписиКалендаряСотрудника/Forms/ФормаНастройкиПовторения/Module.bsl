...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДатаНачалаПовторения = ЗаписьКалендаря.Начало;
...
Процедура Готово(Команда)
	...
	РаботаСКалендаремКлиент.УстановитьПовторение(ЗаписьКалендаря, ПолучитьНастройкиПовторения());
...
Процедура ОбновитьОтображение()
	...
	ИнтервалЕдиницаИзмерения =
		РаботаСКалендаремКлиентСервер.ПолучитьТекстовоеПредставлениеЕдиницыИзмеренияИнтервалаПовторения(
			НастройкиПовторения);
...
Функция ПолучитьНастройкиПовторения()
	...
	Если ЧастотаПовторения = ПредопределенноеЗначение("Перечисление.ЧастотаПовторения.Ежемесячно") Тогда
		...
		ИначеЕсли НастройкаСпособаПовторенияВМесяце = 1 Тогда
			ПовторениеПоДнямНеделиВМесяце = РаботаСКалендаремКлиентСервер.ПолучитьДеньНеделиВМесяце(ДатаНачалаПовторения);
		КонецЕсли;
