...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РаботаСЦветомКлиентСервер.ЗаполнитьСписокВыбораВремени(Элементы.НачалоРабочегоДня, 3600, '00010101000000', '00010101230000');
	РаботаСЦветомКлиентСервер.ЗаполнитьСписокВыбораВремени(Элементы.ОкончаниеРабочегоДня, 3600, '00010101000000', '00010101230000');
