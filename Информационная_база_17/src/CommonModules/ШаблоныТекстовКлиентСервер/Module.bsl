...
//                                при отправке;
//   * ФорматПисьма - ПеречислениеСсылка.ТипыТекстовПочтовыхСообщений - Вид текста письма: HTML или ОбычныйТекст;
...
Функция ОписаниеПараметровШаблона() Экспорт
	...
	Результат.Вставить("ФорматПисьма", ПредопределенноеЗначение("Перечисление.ТипыТекстовПочтовыхСообщений.HTML"));
