...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,
		Метаданные.Документы.Задачи.ПолноеИмя(),
		"ДатаСтатуса", "ГруппыДоступаЗаказчики",      "Заказчик.ГруппаДоступа");
		
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,
		Метаданные.РегистрыСведений.ИсторияЗадач.ПолноеИмя(),
		"Период", "", "");
		
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,
		Метаданные.Документы.Трудозатраты.ПолноеИмя(),
		"Дата", "ГруппыДоступаЗаказчики",      "Заказчик.ГруппаДоступа");
...
Процедура ПередПроверкойЗапретаИзменения(Объект,
	...
	//Для задач запрет должен действовать только для закрытого статуса
	Если ТипЗнч(Объект) = Тип("ДокументОбъект.Задачи") Тогда
		
		// задача выполнена или отменена
		Если НЕ Перечисления.СтатусыЗадач.ЭтоСтатусЗакрытойЗадачи(Объект.Ссылка.Статус) Тогда
