...
Процедура ПриПолученииПредставления(ТипДанных, Данные, Представление, СтандартнаяОбработка) Экспорт
	...
	Если МетаданныеОбъекта.Имя = "Задачи" Тогда
		Документы.Задачи.ПредставлениеВСтруктуреПодчиненности(Данные.Ссылка, Представление, СтандартнаяОбработка);
	ИначеЕсли МетаданныеОбъекта.Имя = "ВходящееПисьмо" Тогда
		Документы.ВходящееПисьмо.ПредставлениеВСтруктуреПодчиненности(Данные.Ссылка, Представление, СтандартнаяОбработка);
	ИначеЕсли МетаданныеОбъекта.Имя = "ИсходящееПисьмо" Тогда
		Документы.ИсходящееПисьмо.ПредставлениеВСтруктуреПодчиненности(Данные.Ссылка, Представление, СтандартнаяОбработка);
	КонецЕсли;
