...
//
// Параметры:
//  Шаблон                   - СправочникСсылка.ШаблоныПисем - ссылка на шаблон сообщения.
...
//
// Параметры:
//  Шаблон - ДанныеФормыСтруктура, СправочникСсылка.ШаблоныПисем,
...
Функция ПараметрыШаблона(Знач Шаблон) Экспорт
	...
	Если ТипЗнч(Шаблон) <> Тип("ДанныеФормыСтруктура") 
		И ТипЗнч(Шаблон) <> Тип("СправочникСсылка.ШаблоныПисем") Тогда
