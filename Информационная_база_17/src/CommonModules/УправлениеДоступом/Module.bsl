...
Функция ЧтениеРазрешено(ОписаниеДанных) Экспорт
	...
	Возврат Истина;//УправлениеДоступомСлужебный.ДоступРазрешен(ОписаниеДанных, Ложь);
...
Функция ИзменениеРазрешено(ОписаниеДанных) Экспорт
	...
	Возврат Истина;//УправлениеДоступомСлужебный.ДоступРазрешен(ОписаниеДанных, Истина);
