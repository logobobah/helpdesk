...
// Возвращает значение константы ИспользоватьЦентрОповещенияДляНапоминаний
Функция ПолучитьИспользоватьЦентрОповещенияДляНапоминаний() Экспорт
	
	Возврат НапоминанияПользователяВызовСервера.ПолучитьИспользоватьЦентрОповещенияДляНапоминаний();
