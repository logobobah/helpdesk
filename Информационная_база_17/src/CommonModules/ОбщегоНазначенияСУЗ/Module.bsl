...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	Параметры.Вставить("ПриЗапускеОткрыватьРаздел", СистемаУчетаЗадачСервер.ПриЗапускеОткрыватьРаздел());
...
Функция ЕстьМетодМенеджера(МенеджерОбъекта, ИмяМетода) Экспорт
	...
	Возврат ОбщегоНазначенияСУЗПовтИсп.ЕстьМетодМенеджера(ПолноеИмя, ИмяМетода);
