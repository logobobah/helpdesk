...
Функция ИспользуютсяСвойства(Форма, ДополнительныеПараметры)
	...
	//{{ Изменение БСП. Добавлена возможность для шаблонов задач указывать те же реквизиьты, что и для задач.
	Если ТипОбъекта = Тип("СправочникСсылка.ШаблоныЗадач") Тогда
		ТипОбъекта = Тип("ДокументСсылка.Задачи");
	КонецЕсли;
	//}} Изменение БСП
