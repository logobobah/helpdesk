...
Процедура ОтправкаPushУведомлений() Экспорт
	...
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ОтправкаPushУведомлений);
...
Процедура СозданиеPushУведомленийОНовыхПисьмах() Экспорт
	...
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.СозданиеPushУведомленийОНовыхПисьмах);
...
Функция ОтправитьСообщенияИспользуяPushУведомления(Сообщения, Узлы, ИспользоватьPushУведомления, Протокол)
	...
	Типы.Вставить(Тип("СправочникСсылка.ЗаписиКалендаряСотрудника"), "ЗаписиКалендаряСотрудника");
	Типы.Вставить(Тип("ДокументСсылка.Задачи"), "Задачи");
	...
	Пока ВыборкаСообщений.Следующий() Цикл
		...
		Пока ВыборкаПолучателей.Следующий() Цикл
			...
			Протокол = Протокол + "
				|Идентификатор добавлен: " + Идентификатор;
