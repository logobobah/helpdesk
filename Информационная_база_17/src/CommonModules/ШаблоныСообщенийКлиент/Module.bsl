...
//      * Результат - СправочникСсылка.ШаблоныПисем - выбранный шаблон.
...
//
// Параметры:
//  Значение - СправочникСсылка.ШаблоныПисем, Структура, ЛюбаяСсылка - Если передана ссылка на шаблон сообщения,
...
Процедура ПоказатьФормуШаблона(Значение, ПараметрыОткрытия = Неопределено) Экспорт
	...
	ИначеЕсли ТипЗнч(Значение) = Тип("СправочникСсылка.ШаблоныПисем") Тогда
	...
	ОткрытьФорму("Справочник.ШаблоныПисем.ФормаОбъекта", ПараметрыФормы, ПараметрыОткрытияФормы.Владелец,
...
Процедура ПоказатьФормуСформироватьСообщение(ОписаниеОповещенияОЗакрытии, ПараметрыФормы)
	...
	ОткрытьФорму("Справочник.ШаблоныПисем.Форма.СформироватьСообщение", ПараметрыФормы, ЭтотОбъект,,,, Оповещение);
