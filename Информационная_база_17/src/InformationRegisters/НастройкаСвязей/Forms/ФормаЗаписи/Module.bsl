...
Функция ПолучитьТип(Значение)
	...
	ИначеЕсли ТипЗнч(Значение) = Тип("ДокументСсылка.Задачи") Тогда 
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ТипСсылкаИз = "СправочникСсылка.Файлы" 
		...
		Или ТипСсылкаИз = "ДокументСсылка.Задачи"
	...
	ИначеЕсли ТипСсылкаНа = "СправочникСсылка.Файлы"
		...
		Или ТипСсылкаНа = "ДокументСсылка.Задачи"
...
Функция ПолучитьЧислоДокументовСНезаполненнойОбязательнойСвязью(ТипСвязи, СсылкаИз)
	...
	ИначеЕсли ТипСсылки = Тип("ДокументСсылка.Задачи") Тогда
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "Справочник.Файлы", "Документ.Задачи");
